...
- [x] `PRE-RELEASE` **Accessibility: content descriptions** — DONE: decorative acronym/image content is hidden from accessibility when the adjacent category title already names it; actionable icons and the touch grid expose localized names/actions.
