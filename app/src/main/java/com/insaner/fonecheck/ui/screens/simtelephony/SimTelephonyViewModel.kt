...
class SimTelephonyViewModel
    ...
    constructor(
        ...
        private val _simTelephonyInfo = MutableStateFlow(gatherSimTelephonyInfo(application))
        val simTelephonyInfo: StateFlow<SimTelephonyInfo> = _simTelephonyInfo

        fun refresh() {
            _simTelephonyInfo.value = gatherSimTelephonyInfo(getApplication())
        }
        ...
        private fun gatherSimSlots(
            ...
            return (0 until phoneCount).map { slotIndex ->
                ...
                SimSlotInfo(
                    ...
                    networkType =
                        if (slotIndex == 0 && hasPhoneStatePermission) {
                            mapNetworkType(telephonyManager.dataNetworkType)
                        } else {
                            "Unknown"
                        },
        ...
        private fun mapSimState(state: Int): String =
            when (state) {
        ...
        private fun mapPhoneType(type: Int): String =
            when (type) {
