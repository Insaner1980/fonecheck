...
class CameraTestViewModel @Inject constructor(
    ...
    private fun buildCapabilities(id: String, chars: CameraCharacteristics): CameraCapabilities {
        ...
        val zoomRange = if (android.os.Build.VERSION.SDK_INT >= 30) {
        ...
        val autoFocusModes = afModes?.mapNotNull { mode ->
            when (mode) {
