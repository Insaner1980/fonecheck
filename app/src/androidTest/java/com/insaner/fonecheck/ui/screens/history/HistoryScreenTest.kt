...
class HistoryScreenTest {
    ...
    fun reportsExposeOpenCompareExportAndConfirmedDeleteActions() {
        ...
        composeRule.onNodeWithText(context.getString(R.string.history_partial_check)).assertIsDisplayed()
        composeRule
            .onNodeWithText(
                context.getString(
                    R.string.history_category_retest,
                    context.getString(R.string.home_cat_storage),
                ),
            ).performScrollTo()
            .assertIsDisplayed()
    }
