...
| Item | Value |
|---|---|
| Verified source snapshot | 2026-09-05 |
| Verified Git baseline | `b40f84311355d013a0b58dfd39881a82a4056633` on `codex/android-toolchain-update`; the working tree was clean before this documentation-only update |
...
| Source inventory | 167 production Kotlin files plus 1 debug-only preview Kotlin file; 79 JVM-test Kotlin files (75 files and 369 annotations with `@Test`); 30 instrumented-test Kotlin files (all 30 files, 105 annotations with `@Test`) |
...
| Localization inventory | English: 1,098 strings + 5 plurals; Finnish: 1,097 strings + 5 plurals; both contain the same 1,102 translatable resource names; English additionally contains only the non-translatable `app_name` |
