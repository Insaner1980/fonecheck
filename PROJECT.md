...
| UI | Jetpack Compose, Material 3 plus explicit `material-icons-core`, Compose BOM 2026.06.01 |
| AndroidX shell/lifecycle | Core KTX 1.19.0; Core SplashScreen 1.2.0; Startup Runtime 1.1.1; Lifecycle Runtime Compose 2.11.0; Activity Compose 1.13.0 |
...
| Security automation | CodeQL 4.37.6, Semgrep 1.171.0, OSV-Scanner 2.4.0, project-local DeepSec 2.2.9, dependency verification metadata/keyring, buildscript dependency locking |
...
The root build forces selected buildscript transitives to patched versions: Jackson 2.22.1, protobuf 4.35.1, jose4j 0.9.6, Bouncy Castle 1.85, JDOM 2.0.6.1, and jsoup 1.23.1. It also enables buildscript dependency locking. `gradle/verification-metadata.xml`, `gradle/verification-keyring.keys`, `buildscript-gradle.lockfile`, and the generated `settings-gradle.lockfile` are supply-chain inputs and must move with intentional dependency/plugin or catalog-resolution updates.
